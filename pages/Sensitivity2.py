...
# Cost Coefficients
holding_cost = st.slider("Holding Cost", 0.1, 1000.0, 2.0)  # Cost per unit held
stockout_penalty = st.slider("Stockout Penalty", 10, 1000, 50)  # Cost per stockout
waste_penalty = st.slider("Waste Penalty", 1, 1000, 10) # Cost for expired stock
